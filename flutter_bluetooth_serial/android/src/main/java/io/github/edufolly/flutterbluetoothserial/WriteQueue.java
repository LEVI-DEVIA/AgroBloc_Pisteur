...
public class WriteQueue {
	 ...
	 *   The queue should never have to be asked to deque 
	 *   if it is empty because elements are only popped after callbacks.
	 * */
	 ...
	 * But in the real world callbacks are lost, which will cause all the
